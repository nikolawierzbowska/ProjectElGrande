...
import Lesson2Theory from "../theory/Lesson2Theory";
...
const NavbarLesson2 = () => {
  ...
  const handleQuizeClick = () => {
    setShowQuize(!showQuiz);
    setShowTheory(false);
    setShowFilms(false);
    setShowTasks(false);
    setShowAnswers(false);
  ...
  return (
    <>
      <div className="navigationLesson">
        ...
        <button className="nameOfNav" onClick={handleQuizeClick}>
          Quiz
        </button>
